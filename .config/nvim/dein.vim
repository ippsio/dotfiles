...
"  " lazy0: どんなfiletypeでも動く
  call dein#load_toml('~/.config/nvim/toml/0_lsp.toml', {'lazy': 1})
  ...
  call dein#load_toml('~/.config/nvim/toml/1_syntax.toml', {'lazy': 1})
  call dein#load_toml('~/.config/nvim/toml/1_linter.toml', {'lazy': 1})
