...
call ddc#custom#patch_global('sourceOptions',
    \ #{
    \   _: #{ minAutoCompleteLength: 1, matchers: ['matcher_head'], sorters: ['sorter_rank'],},
    \   around: #{mark: 'A'},
    \   file:   #{mark: 'F', isVolatile: v:true, forceCompletionPattern: '\S/\S*'},
    \   lsp:    #{mark: 'LSP', forceCompletionPattern: join(['\.\w*', '->\w*'], '|')}
    \ })
"   _: #{ minAutoCompleteLength: 1, matchers: ['matcher_fuzzy'], sorters: ['sorter_fuzzy'], converters: ['converter_fuzzy']},
